                    ...
                    <div class="profile-card">
                        ...
                        <div class="profile-card-body">
                            <div class="account-details-item">
                                ...
                                <p class="account-details-value highlight">${{ number_format($staff->hourly_rate ?? 0, 2) }}</p>
                            </div>
                            <div class="account-details-item">
                                <p class="account-details-label">Assigned Weekly Hours</p>
                                <p class="account-details-value">{{ number_format($staff->assigned_weekly_hours ?? 0, 2) }} hours</p>
                            </div>
                            <div class="account-details-item">
                                <p class="account-details-label">Assigned Monthly Hours</p>
                                <p class="account-details-value">{{ number_format($staff->assigned_monthly_hours ?? 0, 2) }} hours</p>
                            </div>
                            <div class="account-details-item">
