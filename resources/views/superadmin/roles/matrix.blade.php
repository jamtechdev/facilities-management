...
@push('styles')
    <style>
        ...
        @keyframes pulse-glow {
            ...
            50% {
                box-shadow: 0 0 25px rgba(132, 195, 115, 0.8);
            }
        }
            ...
            <div class="profile-header-content">
                ...
                @if (auth()->user()->hasRole('SuperAdmin'))
                    <div class="profile-header-actions">
                        <button type="button" class="btn btn-light btn-lg px-4 py-2 shadow-lg rounded-pill fw-semibold"
                                ...
                                @foreach ($permissions as $permission)
                                    <tr>
                                        <td>
                                            ...
                                            @if (auth()->user()->hasRole('SuperAdmin'))
                                                <button type="button"
                                                    class="btn btn-sm btn-link text-danger p-0 ms-2 delete-permission"
                                        ...
                                        @foreach ($roles as $role)
                                            <td>
                                                @php
                                                    ...
                                                    $canEdit =
                                                        !$isSuperAdmin &&
                                                        ($isAdmin ? $user && $user->hasRole('SuperAdmin') : true);
                                                @endphp
                    ...
                    fetch('{{ \App\Helpers\RouteHelper::url('roles.permissions.update') }}', {
                        ...
                        .then(data => {
                            ...
                            if (data && data.success) {
                                ...
                                showToast(`Permission ${action} for ${roleName} role`,
                                    'success');
                            } else {
                                // Revert checkbox state
                                this.checked = originalState;
                                showToast(data?.message || 'Failed to update permission',
                                    'error');
                            }
                        })
                        .catch(error => {
                    ...
                    <form id="createPermissionForm">
                        ...
                        <div class="modal-body">
                            <div class="mb-3">
                                ...
                                <small class="form-text text-muted">Use lowercase with spaces or underscores (e.g., "view
                                    reports" or "view_reports")</small>
                            </div>
                            <div class="mb-3">
