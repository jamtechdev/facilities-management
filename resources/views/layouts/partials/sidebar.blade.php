        ...
        <div class="nav-section">
            ...
            @can('view admin dashboard')
                <div class="nav-item-modern">
                    <a class="nav-link-modern {{ request()->routeIs('admin.dashboard') || request()->routeIs('superadmin.dashboard') ? 'active' : '' }}" href="{{ $user->hasRole('SuperAdmin') ? route('superadmin.dashboard') : route('admin.dashboard') }}">
            ...
            @endcan
            <div class="nav-item-modern">
                <a class="nav-link-modern {{ request()->routeIs('admin.profile*') || request()->routeIs('superadmin.profile*') ? 'active' : '' }}" href="{{ $user->hasRole('SuperAdmin') ? route('superadmin.profile') : route('admin.profile') }}">
