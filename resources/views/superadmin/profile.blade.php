                            ...
                            @forelse($documents as $document)
                                <div class="document-item">
                                    ...
                                    <div class="document-item-actions">
                                        <a href="{{ route('superadmin.profile.documents.download', $document) }}" class="btn btn-light" title="Download">
                                            <i class="bi bi-download"></i>
                                        </a>
                                        <button class="btn btn-light text-danger delete-document-btn" data-delete-url="{{ route('superadmin.profile.documents.destroy', $document) }}">
...
<script>
    ...
    if (documentForm) {
        documentForm.addEventListener('submit', async function(e) {
            ...
            try {
                const response = await fetch('{{ route("superadmin.profile.documents.store") }}', {
                    method: 'POST',
                    body: formData,
                    headers: {
                        'X-Requested-With': 'XMLHttpRequest',
