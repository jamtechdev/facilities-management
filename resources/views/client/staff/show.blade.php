...
<div class="container-fluid">
    ...
    <x-tab-navigation
        :tabs="[
            ...
            ['id' => 'timesheets', 'label' => 'Timesheets', 'icon' => 'bi-clock-history', 'badge' => $staff->timesheets->count()],
            ['id' => 'job-photos', 'label' => 'Job Photos', 'icon' => 'bi-camera', 'badge' => $staff->jobPhotos->count()],
            ['id' => 'documents', 'label' => 'Documents', 'icon' => 'bi-file-earmark', 'badge' => $staff->documents->count()],
        ]"
        id="staffTabs" />
        ...
        <div class="tab-pane fade show active" id="info" role="tabpanel">
            <div class="row g-3">
                ...
                @if($assignment)
                    ...
                    <div class="col-md-6 col-lg-4">
                        <x-info-card label="Assigned Weekly Hours (To You)" :value="$assignment->pivot->assigned_weekly_hours ? $assignment->pivot->assigned_weekly_hours . ' hours' : '-'" />
                    </div>
                    <div class="col-md-6 col-lg-4">
                        <x-info-card label="Assigned Monthly Hours (To You)" :value="$assignment->pivot->assigned_monthly_hours ? $assignment->pivot->assigned_monthly_hours . ' hours' : '-'" />
                    </div>
                    <div class="col-md-6 col-lg-4">
                        <x-info-card
                            label="Assignment Status"
                            :badge="$assignment->pivot->is_active ? 'Active' : 'Inactive'"
                            :badgeColor="$assignment->pivot->is_active ? 'success' : 'secondary'" />
                    </div>
