    ...
    <div class="profile-header">
        <div class="profile-header-content">
            <div class="profile-avatar">
                <i class="bi bi-shield-check icon-2-5rem"></i>
            </div>
            ...
            <div class="profile-header-actions">
                <button type="button" class="btn btn-light btn-lg px-4 py-2 shadow-lg rounded-pill fw-semibold" data-bs-toggle="modal" data-bs-target="#createPermissionModal">
