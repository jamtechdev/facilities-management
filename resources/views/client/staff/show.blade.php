            ...
            <div class="tab-pane fade show active" id="info" role="tabpanel">
                <div class="row g-3">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <x-info-card label="Name" :value="$staff->name ?? 'N/A'" />
                    </div>
                    <div class="col-md-6 col-lg-4">
                        <x-info-card label="Email" :value="$staff->email ?? 'N/A'" :link="($staff->email ?? null) ? 'mailto:' . $staff->email : null" />
                    </div>
                    <div class="col-md-6 col-lg-4">
                                ...
                                <div class="document-item">
                                    <div class="text-center">
                                        <img src="{{ $imageUrl }}" alt="Job Photo" class="img-thumbnail" loading="lazy"
                                            ...
                                            onclick="openImageModal('{{ $imageUrl }}', 'Job Photo - {{ $staff->name ?? 'N/A' }}')"
