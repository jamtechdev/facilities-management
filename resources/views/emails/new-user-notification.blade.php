...
<body>
    <div class="email-container">
        ...
        <div class="email-body">
            ...
            <p>A new <strong>{{ $role }}</strong> has registered on the platform.</p>
            ...
            <div class="info-box">
                ...
                <div class="info-item">
                    ...
                    <span class="info-value">{{ $newUser->created_at->format('F d, Y h:i A') }}</span>
                </div>
            </div>

            <p>Please review the new user's account and take any necessary actions.</p>
