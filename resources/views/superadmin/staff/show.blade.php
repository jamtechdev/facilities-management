...
<div class="container-fluid">
    ...
    <x-tab-navigation
        :tabs="[
            ...
            ['id' => 'clients', 'label' => 'Assigned Clients', 'icon' => 'bi-building', 'badge' => $staff->clients->count()],
            ...
            ['id' => 'leads', 'label' => 'Assigned Leads', 'icon' => 'bi-person-lines-fill', 'badge' => $staff->leads->count()]
        ]"
        id="staffTabs" />
                ...
                <div class="row g-3">
                    @foreach($staff->clients as $client)
                        ...
                        <div class="col-md-6 col-lg-4">
                            <x-info-card
                                label="Status"
                                :badge="$client->pivot->is_active ? 'Active' : 'Inactive'"
                                :badgeColor="$client->pivot->is_active ? 'success' : 'secondary'" />
                        </div>
                        @if(!$loop->last)
