...
<div class="container-fluid admin-dashboard-content">
    ...
    <div class="row g-4 mb-4">
        ...
        <div class="col-xl-3 col-md-6">
            <a href="{{ \App\Helpers\RouteHelper::url('clients.index') }}" class="superadmin-stat-card text-decoration-none">
                <div class="stat-header">
                    <div class="stat-content">
        ...
        <div class="col-xl-3 col-md-6">
            <a href="{{ \App\Helpers\RouteHelper::url('staff.index') }}" class="superadmin-stat-card text-decoration-none">
                <div class="stat-header">
                    <div class="stat-content">
        ...
        <div class="col-xl-3 col-md-6">
            <a href="{{ \App\Helpers\RouteHelper::url('invoices.index') }}" class="superadmin-stat-card text-decoration-none">
                <div class="stat-header">
                    <div class="stat-content">
    ...
    <div class="row g-4 mb-4">
        ...
        <div class="col-xl-3 col-md-6">
            <a href="{{ \App\Helpers\RouteHelper::url('leads.index') }}?stage=new_lead" class="superadmin-stat-card text-decoration-none">
                <div class="stat-header">
                    <div class="stat-content">
