...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // This is the only seeder needed as dashboard cards are dynamic and pull data from database
        ...
        // All other seeders are commented out - only admin and superadmin users will be created
        // Step 2: Create staff
        ...
        $this->command->info('');
        $this->command->info('Note: Dashboard cards are dynamic and will show real data from the database.');
    }
}
