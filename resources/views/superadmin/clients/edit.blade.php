                    ...
                    <form id="updateClientForm" method="POST" action="{{ route('admin.clients.update', $client) }}">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control @error('contact_person') is-invalid @enderror" id="contact_person" name="contact_person" value="{{ old('contact_person', $client->contact_person) }}" required>
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-select @error('billing_frequency') is-invalid @enderror" id="billing_frequency" name="billing_frequency">
                                    ...
                                    <option value="weekly" {{ old('billing_frequency', $client->billing_frequency) == 'weekly' ? 'selected' : '' }}>Weekly</option>
                                    <option value="bi-weekly" {{ old('billing_frequency', $client->billing_frequency) == 'bi-weekly' ? 'selected' : '' }}>Bi-Weekly</option>
                                    <option value="monthly" {{ old('billing_frequency', $client->billing_frequency) == 'monthly' ? 'selected' : '' }}>Monthly</option>
                                    <option value="quarterly" {{ old('billing_frequency', $client->billing_frequency) == 'quarterly' ? 'selected' : '' }}>Quarterly</option>
                                </select>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" step="0.5" class="form-control @error('agreed_weekly_hours') is-invalid @enderror" id="agreed_weekly_hours" name="agreed_weekly_hours" value="{{ old('agreed_weekly_hours', $client->agreed_weekly_hours) }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" step="0.5" class="form-control @error('agreed_monthly_hours') is-invalid @enderror" id="agreed_monthly_hours" name="agreed_monthly_hours" value="{{ old('agreed_monthly_hours', $client->agreed_monthly_hours) }}">
